...
def centeredCrop(img, output_side_length):
	...
	height_offset = round((new_height - output_side_length) / 2)
	width_offset = round((new_width - output_side_length) / 2)
...
def main():
	...
	outputFile = "../Weights/PoseNet_new.ckpt"
	...
	with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
		...
		for i in range(max_iterations):
			...
			if i % 10 == 0:
				...
				print("Time elapsed now is " + str(t2 - t1) + "seconds")
			if i % 5000 == 0:
